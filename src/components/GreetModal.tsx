...
const GreetModal:FunctionComponent<{onConfirm:()=>void}> = ({
    ...
    return <div className="fixed  inset-0 flex items-center justify-center bg-gray-900 text-black dark:text-white bg-opacity-50 z-[62]">
        ...
        <div >
                <svg className="animate-tada size-1/5 xs:size-1/3 m-auto" width="264" height="264" viewBox="0 0 264 264" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="132" cy="132" r="120" fill="#EE7B22" fillOpacity="0.2" />
                    <circle cx="132" cy="132" r="132" fill="#EE7B22" fillOpacity="0.1" />
                    <circle cx="132" cy="132" r="108" fill="#EE7B22" fillOpacity="0.4" />
                    <circle cx="132" cy="132" r="96" fill="#EE7B22" fillOpacity="0.6" />
