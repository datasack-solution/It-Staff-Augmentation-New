            ...
            <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div className="flex min-h-full items-end justify-center text-center sm:items-center sm:p-0">
                    <div className="relative m-auto transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        <div className="bg-white dark:bg-[#252525]  px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">

                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                    <div className="flex justify-between">
                                        <h3 className="text-base font-semibold  text-gray-900 dark:text-white" id="modal-title">Do you want to add custom tech&apos;s for {selectedCategory} ?</h3>
                                    ...
                                    <div className="flex flex-col gap-5 mt-7 dark:text-white">
                                        <fieldset className="w-full m-auto h-auto border-2 rounded-full px-5 py-1">
                                            ...
                                            <input
                                                ...
                                                className="w-full outline-none rounded-full px-2 py-1 dark:bg-[#252525]"
