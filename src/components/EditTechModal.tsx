                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                    <div className="flex justify-between">
                                        <h3 className="text-base font-semibold  text-gray-900 mb-5" id="modal-title">Selected Technologies
                                                    ...
                                                    <div className="relative items-center justify-center rounded-full w-full">
                                                        ...
                                                        <div className="flex items-center bg-white rounded-full p-2 gap-2 ">
                                                            ...
                                                            <div className="flex align-middle m-auto gap-2 max-w-fit mr-5">
                                                                ...
                                                                <span className="text-black rounded-full w-5 h-5 text-center justify-center bg-[rgba(238,123,34,0.14)]">{quantities[index]}</span>
