...
const DarkToggle:FunctionComponent<{className:string, onClick:()=>void}> = ({className,onClick}) => {
    return <svg aria-label="Dark-Theme" onClick={onClick} className={className} width="52" height="24" viewBox="0 0 52 24" fill="none" xmlns="http://www.w3.org/2000/svg">
