                    ...
                    {Object.keys(technologies).map((category, index) => (
                        <div className='relative' key={index}>
                            <button
                                ...
                                className={`border max-h-fit w-full border-orange-500 py-2 px-4 rounded-full transition-colors ${selectedCategory === category ? "bg-orange-500 text-white" : "text-black"
                                    } ${quantities[category] &&
