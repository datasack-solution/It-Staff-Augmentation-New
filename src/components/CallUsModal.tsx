...
const CallUsModal: FunctionComponent<AddTechModalProps> = ({
    ...
    return <div className="fixed inset-0 flex items-center justify-center bg-gray-900 text-black bg-opacity-50 z-[62]">
        <div className="bg-white w-full max-h-[600] md:max-h-screen lg:max-h-screen xl:max-h-screen 2xl:max-h-screen  max-w-3xl mx-4 md:mx-0 p-6 rounded-lg shadow-lg relative overflow-auto">
            ...
            <form className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <select className="w-full border border-gray-300 rounded-full py-2 px-4 outline-none focus:ring-2 focus:ring-orange-500">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Enter Your Name" className="w-full border border-gray-300 rounded-full py-2 px-4 outline-none focus:ring-2 focus:ring-orange-500" />
                    </div>
                    <div>
                        <label className="text-gray-600 text-sm">Corporate Email</label>
                        <input type="email" placeholder="Corporate Email" className="w-full border border-gray-300 rounded-full py-2 px-4 outline-none focus:ring-2 focus:ring-orange-500" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="date" className="w-full border border-gray-300 rounded-full py-2 px-4 outline-none focus:ring-2 focus:ring-orange-500" />
                    </div>
                    <div>
                        <label className="text-gray-600 text-sm">Select Time</label>
                        <input type="time" className="w-full border border-gray-300 rounded-full py-2 px-4 outline-none focus:ring-2 focus:ring-orange-500" />
                        {/* <select className="w-full border border-gray-300 rounded-full py-2 px-4 outline-none focus:ring-2 focus:ring-orange-500">
                ...
                <div>
                    ...
                    <textarea placeholder="Reason" className="w-full border border-gray-300 rounded-lg py-2 px-4 outline-none focus:ring-2 focus:ring-orange-500"></textarea>
                </div>

                <div className="flex items-center space-x-2">
                    <input type="checkbox" id="nda" className="h-5 w-5 text-orange-500 focus:ring-orange-500" />
                    <label className="text-gray-600 text-sm">I Want to Protect My Data by Signing an NDA</label>
                </div>
